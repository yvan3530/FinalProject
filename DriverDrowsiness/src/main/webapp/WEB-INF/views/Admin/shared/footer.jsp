	<footer class="footer">
		<div class="content">
			...
			<p class="company-description">KESI Investment Rwanda ltd is an integrated transport and logistics services provider with the Head Office in Kigali, 
			Rwanda KESI Investment Rwanda ltd was established in 2016 with a fleet of 100 trucks that moved our client’s goods within the region.
                Now we have more than 320 employees and more than 184 trucks. We have made a strong repute for 
                impeccable transport and logistics services in East African Countries, which is characterized 
                by Efficiency, Quality and Professionalism. We provide our services in Rwanda, Kenya, Uganda, Tanzania and we have blanches 
                in those countries
                .</p>
