                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="${contextRoot }/dashboard">Staff</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="text-lg-right">
                                                     <a href="${contextRoot }/manage/pdfStaff">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered mb-0">
                                                ...
                                                |
                                                 <a href="${deleteLink}"
                                                 onclick="if (!(confirm('Are you sure you want to delete this staff ?')))return false">delete</a>
                                                </td>
                                                </tr>
