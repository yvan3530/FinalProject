<div class="main-content" style="padding: 30px 60px;">
	<section class="section-intro section-intro_lcl">
		<div class="content">
			<div class="text-part">
		...
		<div class="content">
			<div class="text-part">
			<h2>The most common symptoms of COVID-19 are</h2>
			
.Fever</br>
.Dry cough</br>
.Fatigue</br>
</br>
Other symptoms that are less common and may affect some patients include:</br>
</br>
