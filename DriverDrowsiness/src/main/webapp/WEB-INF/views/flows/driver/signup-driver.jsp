											...
											<div class="row">
												<div class="col-lg-8">
													...
													<sf:form method="GET" class="form-horizontal"
														id="registerForm" modelAttribute="driver">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<sf:input class="form-control" type="text"
																		path="address" placeholder="Enter your address"
																		id="billing-first-name" />
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<sf:input class="form-control" type="text"
																		path="telePhone" placeholder="Enter your phone Number"
																		id="billing-last-name" />
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label for="billing-first-name">Passport Number</label>
																	<sf:input class="form-control" type="text"
																		path="passPortNumber"
																		placeholder="Enter your passPort Number"
																		id="billing-first-name" />
																	<sf:errors path="passPortNumber" cssClass="help-block"
																		element="em" />
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label for="billing-last-name">Driving License</label>
																	<sf:input class="form-control" type="text"
																		path="drivingLicense"
																		placeholder="Enter your driving License"
																		id="billing-last-name" />
																	<sf:errors path="drivingLicense" cssClass="help-block"
																		element="em" />
																</div>
															</div>
														</div>
