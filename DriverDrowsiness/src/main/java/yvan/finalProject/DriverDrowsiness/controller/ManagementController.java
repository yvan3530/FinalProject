...
public class ManagementController {
	...
	public String handleBooking(@Valid @ModelAttribute("booking") Booking nBooking,BindingResult results, Model model) {
